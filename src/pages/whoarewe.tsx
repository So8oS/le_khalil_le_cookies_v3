      ...
      <div className="mt-10 flex max-w-[70rem] flex-col items-center justify-center gap-5 rounded-3xl bg-[#EBCC9B] p-10 shadow">
        ...
        <div className="flex flex-col items-center justify-center gap-2 text-center">
          <p className="text-center text-xl font-medium md:text-2xl">
            ...
            {`Let me introduce you to my friend, the cookie enthusiast turned entrepreneur. With  and a passion for cookies, he started selling his mouthwatering treats in uni during his third year.
